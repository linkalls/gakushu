...
- [x] 音声読み上げ機能
- [x] カスタムカードテンプレート
- [x] Anki Web風共有機能（デッキ共有・ダウンロード）
- [x] ユーザーランキング機能（学習履歴・統計）
- [x] クロスプラットフォーム対応（Web + モバイル共通アカウント）
- [ ] プラグインシステム
...
### Anki Web風共有機能
- **デッキ共有**: 自分のデッキを公開・共有
- **カード一覧共有**: 公開デッキのブラウズ・ダウンロード
- **いいね機能**: 人気デッキのランキング
- **シェアコード**: URLで簡単共有

### ユーザーランキング
- **グローバルランキング**: 総レビュー数でランキング
- **連続学習日数ランキング**: ストリークで競争
- **学習時間ランキング**: 累計学習時間で比較
- **個人統計**: 日次・週次・月次の学習データ

### オフライン同期
- **自動同期キュー**: オフライン時の変更を自動保存
- **クラウドバックアップ**: 複数デバイス間でデータ同期
- **デバイス別管理**: Web・iOS・Android個別管理
- **競合解決**: 自動マージ機能

### カスタムテンプレート
- **テンプレート作成**: HTML/CSS/JavaScriptでカスタマイズ
- **公開テンプレート**: コミュニティ共有
- **テンプレートストア**: 人気テンプレートをダウンロード

### 音声読み上げ
- **自動再生**: カード表示時に自動読み上げ
- **速度・ピッチ調整**: 好みに合わせてカスタマイズ
- **多言語対応**: Web Speech API対応の全言語
- **フィールド選択**: 読み上げるフィールドを指定
